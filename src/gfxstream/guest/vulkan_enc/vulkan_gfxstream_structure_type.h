...
#define VK_STRUCTURE_TYPE_DEBUG_METADATA_GOOGLE VK_GOOGLE_GFXSTREAM_ENUM(VkStructureType, 3)
#define VK_STRUCTURE_TYPE_DEBUG_METADATA_GUEST_PROCESS_NAME_GOOGLE \
    VK_GOOGLE_GFXSTREAM_ENUM(VkStructureType, 4)
#define VK_STRUCTURE_TYPE_DEBUG_METADATA_GUEST_PROCESS_ID_GOOGLE \
    VK_GOOGLE_GFXSTREAM_ENUM(VkStructureType, 5)
#define VK_STRUCTURE_TYPE_DEBUG_METADATA_GUEST_THREAD_NAME_GOOGLE \
    VK_GOOGLE_GFXSTREAM_ENUM(VkStructureType, 6)
#define VK_STRUCTURE_TYPE_DEBUG_METADATA_GUEST_THREAD_ID_GOOGLE \
    VK_GOOGLE_GFXSTREAM_ENUM(VkStructureType, 7)
